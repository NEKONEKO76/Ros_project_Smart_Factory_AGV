...
# 更新日志
"""
在本节点中添加了一项service，可以调用这个服务更改targetid，抓取不同的apriltag
"""
...
from visual_processing.srv import SetTargetID, SetTargetIDResponse
...
if __name__ == '__main__':
    ...
    # 这里不更改ID所以不需要
    target_id_srv = rospy.Service('/visual_processing/set_target_id', SetTargetID, set_target_id)
